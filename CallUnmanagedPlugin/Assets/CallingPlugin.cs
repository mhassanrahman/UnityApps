...
public class CallingPlugin : MonoBehaviour
{
    ...
    [DllImport("plugin", EntryPoint = "SimpleTypeReturnFun")]
    private static extern int SimpleTypeReturnFun();

    //-------------------  1.2. Passing simple type    -----------------------------------------------
    [DllImport("plugin", EntryPoint = "SimpleTypeArgFun")]
    private static extern int SimpleTypeArgFun(int n);

    //-------------------  1.3. Passing reference    -------------------------------------------------
    [DllImport("plugin", EntryPoint = "ReferenceArgumentFun")]
    ...
    [DllImport("plugin", EntryPoint = "SimpleCallbackFun")]
    ...
    [DllImport("plugin", EntryPoint = "SimpleReturnCallbackFun")]
    ...
    [DllImport("plugin", EntryPoint = "SimpleArgCallbackFun")]
